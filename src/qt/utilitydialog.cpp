    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("KickerRoom Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About KickerRoom Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  kickerroom-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the KickerRoom in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 KRM, 0.1 KRM, 1 KRM and 10 KRM -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://kickerroomcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://kickerroomcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("KickerRoom Core is shutting down...") + "<br /><br />" +
