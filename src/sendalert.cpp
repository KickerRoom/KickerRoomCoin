...
2. run kickerroomd with -printalert or -sendalert like this:
   /path/to/kickerroomd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.kickerroom.site";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/KickerRoom Core:0.12.0.58/"));
