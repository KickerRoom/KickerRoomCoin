...
This mechanism has been integrated into Bitcore-Node-KickerRoom which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/kickerroomcoin/insight-api-kickerroom#web-socket-api](https://github.com/kickerroomcoin/insight-api-kickerroom#web-socket-api) 
* API: [https://github.com/kickerroomcoin/insight-api-kickerroom#instantsend-transactions](https://github.com/kickerroomcoin/insight-api-kickerroom#instantsend-transactions) 
...
By default, the KickerRoom Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the KickerRoom Core daemon:
