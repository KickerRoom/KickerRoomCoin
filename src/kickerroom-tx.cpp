...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("KickerRoom Core kickerroom-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  kickerroom-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kickerroom transaction") + "\n" +
              "  kickerroom-tx [options] -create [commands]   " + _("Create hex-encoded kickerroom transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded kickerroom transaction
