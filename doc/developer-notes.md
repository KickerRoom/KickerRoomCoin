...
KickerRoom Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as KickerRoom Core, where everyone uses
...
pay attention to for reviewers of KickerRoom Core code.

General KickerRoom Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: KickerRoom Core uses tinyformat, which is type safe. Leave them out to avoid confusion
