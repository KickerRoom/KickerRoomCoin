...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "KickerRoomNetwork") type = KickerRoomNetwork;
    if(strType == "KickerRoomNetworkVariable") type = KickerRoomNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == KickerRoomNetwork) s = "KickerRoomNetwork";
    if(type == KickerRoomNetworkVariable) s = "KickerRoomNetworkVariable";
