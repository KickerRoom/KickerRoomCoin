    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("KickerRoom Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a KickerRoom address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and kickerroom: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About KickerRoom Core"), this);
    aboutAction->setStatusTip(tr("Show information about KickerRoom Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for KickerRoom Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your KickerRoom addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified KickerRoom addresses"));
    ...
    openAction->setStatusTip(tr("Open a kickerroom: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the KickerRoom Core help message to get a list with possible KickerRoom Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("KickerRoom Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to KickerRoom network", "", count));
}
...
{
    QString strTitle = tr("KickerRoom Core"); // default title
    ...
    // Append title to "KickerRoom Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
