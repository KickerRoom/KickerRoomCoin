 ...
 *
 *   // network
 *   CKickerRoomNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.kickerroom.site/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CKickerRoomNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CKickerRoomNetwork(UniValue objIn)
    {
...
// // can be under: KickerRoomNetwork
// //   -- signature requirements : Key1(User)
// class CKickerRoomNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == KickerRoomNetwork);
//     // }
