    ...
    mapper(0)
{
    ...
    /* Theme selector */
    /*ui->theme->addItem(QString("KRM-light"), QVariant("light"));*/
    ui->theme->addItem(QString("KRM-blue"), QVariant("drkblue"));
    /*ui->theme->addItem(QString("KRM-Crownium"), QVariant("crownium"));*/
    ui->theme->addItem(QString("KRM-traditional"), QVariant("trad"));
