...
{
    if(fLiteMode) return; // ignore all KickerRoom related functionality
...
/*
    ...
    allow endless transaction that would bloat KickerRoom and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("kickerroom-privatesend");
